...
// document.getElementById('photoshop').addEventListener('click', (eventObj) => {
...
/*  2) preventDefault
      ...
      - For example below, now hyperlink will not when clicked.
*/
...
/*   1) Bubbling Up - ( child -> parent )
      ...
      - In bubbling first the child is clicked, then the parent.
...
// document.getElementById('prayer2').addEventListener('click', (e) => {
//       console.log('Prayer1 image is clicked');
// }, true);
...
//       console.log('River image is clicked');
//       e.stopPropagation()
// });
